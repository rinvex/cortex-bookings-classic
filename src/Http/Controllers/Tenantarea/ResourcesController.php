...
use Cortex\Bookings\DataTables\Tenantarea\ResourcesDataTable;
...
class ResourcesController extends AuthorizedController
{
     ...
     *
     * @param \Cortex\Bookings\DataTables\Tenantarea\ResourcesDataTable $resourcesDataTable
     *
     ...
     *
     * @param \Cortex\Bookings\Http\Requests\Tenantarea\ResourceFormRequest $request
     *
    ...
    public function delete(ResourceContract $resource)
    {
        ...
        return intend([
            'url' => route('tenantarea.resources.index'),
    ...
    {
        return view('cortex/bookings::tenantarea.forms.resource', compact('resource'));
    }
