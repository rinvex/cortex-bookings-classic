...
class EventsController extends AuthorizedController
{
    ...
    public function logs(Event $event, LogsDataTable $logsDataTable)
    {
        return $logsDataTable->with([
            ...
            'id' => "adminarea-events-{$event->getRouteKey()}-logs",
    ...
    public function import(Event $event, ImportRecordsDataTable $importRecordsDataTable)
    {
        return $importRecordsDataTable->with([
            ...
            'id' => "adminarea-events-{$event->getRouteKey()}-import",
    ...
    public function importLogs(ImportLogsDataTable $importLogsDatatable)
    {
        return $importLogsDatatable->with([
            ...
            'tabs' => 'adminarea.events.tabs',
            'id' => 'adminarea-events-import-logs',
        ])->render('cortex/foundation::adminarea.pages.datatable-tab');
    }
    ...
    protected function process(FormRequest $request, Event $event)
    {
        ...
        return intend([
            ...
            'with' => ['success' => trans('cortex/foundation::messages.resource_saved', ['resource' => trans('cortex/bookings::common.event'), 'identifier' => strip_tags($event->name)])],
        ]);
    }
    ...
    public function destroy(Event $event)
    {
        ...
        return intend([
            'url' => route('adminarea.events.index'),
            'with' => ['warning' => trans('cortex/foundation::messages.resource_deleted', ['resource' => trans('cortex/bookings::common.event'), 'identifier' => strip_tags($event->name)])],
        ]);
    }
}
