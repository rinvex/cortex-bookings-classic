...
class RoomsDataTable extends AbstractDataTable
{
    ...
    protected function getColumns(): array
    {
        $link = config('cortex.foundation.route.locale_prefix')
            ? '"<a href=\""+routes.route(\'adminarea.rooms.edit\', {room: full.name, locale: \''.$this->request->segment(1).'\'})+"\">"+data+"</a>"'
            : '"<a href=\""+routes.route(\'adminarea.rooms.edit\', {room: full.name})+"\">"+data+"</a>"';
