...
class RoomsDataTable extends AbstractDataTable
{
    ...
    protected function getColumns()
    {
        $link = config('cortex.foundation.route.locale_prefix')
            ? '"<a href=\""+routes.route(\'adminarea.rooms.edit\', {room: full.slug, locale: \''.$this->request->segment(1).'\'})+"\">"+data+"</a>"'
            : '"<a href=\""+routes.route(\'adminarea.rooms.edit\', {room: full.slug})+"\">"+data+"</a>"';
