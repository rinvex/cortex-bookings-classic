    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="nav-tabs-custom">
                @if($room->exists && $currentUser->can('delete-rooms', $room)) <div class="pull-right"><a href="#" data-toggle="modal" data-target="#delete-confirmation" data-modal-action="{{ route('managerarea.rooms.delete', ['room' => $room]) }}" data-modal-title="{!! trans('cortex/foundation::messages.delete_confirmation_title') !!}" data-modal-body="{!! trans('cortex/foundation::messages.delete_confirmation_body', ['type' => 'room', 'name' => $room->slug]) !!}" title="{{ trans('cortex/foundation::common.delete') }}" class="btn btn-default" style="margin: 4px"><i class="fa fa-trash text-danger"></i></a></div> @endif
                ...
                <div class="tab-content">
                    ...
                    @if($room->exists)
                        ...
                        <div class="tab-pane" id="media-tab">
                            ...
                            {!! $media->table(['class' => 'table table-striped table-hover responsive dataTableBuilder', 'id' => "managerarea-rooms-{$room->getKey()}-media-table"]) !!}
                        </div>

                        <div class="tab-pane" id="logs-tab">
                            {!! $logs->table(['class' => 'table table-striped table-hover responsive dataTableBuilder', 'id' => "managerarea-rooms-{$room->getKey()}-logs-table"]) !!}
                        </div>
