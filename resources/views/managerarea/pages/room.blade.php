...
@push('inline-scripts')
    {!! JsValidator::formRequest(Cortex\Bookings\Http\Requests\Managerarea\RoomFormRequest::class)->selector("#managerarea-rooms-create-form, #managerarea-rooms-{$room->getRouteKey()}-update-form")->ignore('.skip-validation') !!}
@endpush
                ...
                @if($room->exists && $currentUser->can('delete', $room))
                    <div class="pull-right">
                        <a href="#" data-toggle="modal" data-target="#delete-confirmation"
                           data-modal-action="{{ route('managerarea.rooms.destroy', ['room' => $room]) }}"
